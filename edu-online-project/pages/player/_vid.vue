<template>
  <div>
    ...
    <!--组件-->
    <script  src="https://player.alicdn.com/aliplayer/presentation/js/aliplayercomponents.min.js"/>
    <!-- 定义播放器dom -->
...
export default {
  ...
  asyncData({ params, error }) {
    return course.getPlayAuthByVideoId(params.vid).then(response => {
      return {
        vid: params.vid,
 ...
 */
  mounted() {
    ...
    const player = new Aliplayer({
      ...
      height: '500px',
      // 以下可选设置
      cover: 'https://guliuedu-online.oss-cn-beijing.aliyuncs.com/2020/09/18/e21f5430bc4c431583dac1b23d1e717bfile.png', // 封面
